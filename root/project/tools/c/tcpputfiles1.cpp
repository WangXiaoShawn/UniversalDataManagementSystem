...
void _help()
{
  ...
  printf("Sample:/project/tools1/bin/procctl 20 /project/tools/bin/tcpputfiles1 ~/root/log/idc/tcpputfiles_surfdata.log \"<ip>10.0.2.15</ip><port>5005</port><ptype>1</ptype><clientpath>~/root/tmp/tcp/surfdata1</clientpath><clientpathbak>~/root/tmp/tcp/surfdata1bak</clientpathbak><andchild>true</andchild><matchname>*.XML,*.CSV</matchname><srvpath>~/root/tmp/tcp/surfdata2</srvpath><timetvl>10</timetvl><timeout>50</timeout><pname>tcpputfiles_surfdata</pname>\"\n");
  printf("       /project/tools1/bin/procctl 20 /project/tools1/bin/tcpputfiles /log/idc/tcpputfiles_surfdata.log \"<ip>10.0.2.15</ip><port>5005</port><ptype>2</ptype><clientpath>/tmp/tcp/surfdata1</clientpath><clientpathbak>/tmp/tcp/surfdata1bak</clientpathbak><andchild>true</andchild><matchname>*.XML,*.CSV</matchname><srvpath>/tmp/tcp/surfdata2</srvpath><timetvl>10</timetvl><timeout>50</timeout><pname>tcpputfiles_surfdata</pname>\"\n\n\n");
