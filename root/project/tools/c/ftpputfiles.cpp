...
printf("Sample:/project/tools1/bin/procctl 30 /project/tools/bin/ftpputfiles ~/root/log/idc/ftpputfiles_surfdata.log \"<host>10.0.2.15:21</host><mode>1</mode><username>cis623-vm</username><password>cis623</password><localpath>/home/cis623-vm/root/idcdata/surfdata</localpath><remotepath>/home/cis623-vm/root/tmp/ftpputest</remotepath><matchname>SURF_ZH*.JSON</matchname><ptype>1</ptype><localpathbak>/home/cis623-vm/root/tmp/idc/surfdatabak</localpathbak><okfilename>/home/cis623-vm/root/idcdata/ftplist/ftpputfiles_surfdata.xml</okfilename><timeout>80</timeout><pname>ftpputfiles_surfdata</pname>\"\n\n\n");

printf("This program is a general-purpose module for uploading files from a local directory to a remote FTP server.\n");
printf("logfilename is the log file for this program's execution.\n");
printf("xmlbuffer are the parameters for file upload, as follows:\n");
printf("<host>127.0.0.1:21</host> The IP and port of the remote server.\n");
printf("<mode>1</mode> Transfer mode, 1-Passive mode, 2-Active mode, default is Passive mode.\n");
printf("<username>wucz</username> Username of the remote server's FTP.\n");
printf("<password>wuczpwd</password> Password of the remote server's FTP.\n");
printf("<remotepath>/tmp/ftpputest</remotepath> The directory on the remote server where files are stored.\n");
printf("<localpath>/tmp/idc/surfdata</localpath> The directory where local files are stored.\n");
printf("<matchname>SURF_ZH*.JSON</matchname> Matching rule for files to be uploaded. "\
       "Files that do not match will not be uploaded. This field should be as precise as possible, and it is not recommended to use * to match all files.\n");
printf("<ptype>1</ptype> The treatment of local files after successful upload: 1-Do nothing; 2-Delete; 3-Backup, if 3, specify the backup directory.\n");
printf("<localpathbak>/tmp/idc/surfdatabak</localpathbak> After the file is successfully uploaded, the backup directory for the local file. This parameter is only effective when ptype=3.\n");
printf("<okfilename>/idcdata/ftplist/ftpputfiles_surfdata.xml</okfilename> The list of successfully uploaded filenames, this parameter is only effective when ptype=1.\n");
printf("<timeout>80</timeout> The timeout for uploading files, in seconds, depending on the file size and network bandwidth.\n");
printf("<pname>ftpputfiles_surfdata</pname> Process name, should be as easy to understand as possible and different from other process names, for easy troubleshooting.\n\n\n");
