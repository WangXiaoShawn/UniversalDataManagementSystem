...
void _help()
{
  ...
  printf("Sample:/project/tools1/bin/procctl 30 ~/tmp/project/tools1/bin/ftpgetfiles ~/tmp/log/idc/ftpgetfiles_surfdata.log \"<host>10.0.2.15:21</host><mode>1</mode><username>cis623-vm</username><password>cis623</password><localpath>/idcdata/surfdata</localpath><remotepath>/tmp/idc/surfdata</remotepath><matchname>SURF_ZH*.XML,SURF_ZH*.CSV</matchname><listfilename>/idcdata/ftplist/ftpgetfiles_surfdata.list</listfilename>\"\n\n\n");
