...
/*
 * Program Name: execsql.cpp The  This is a tool program for executing an SQL script file.
 * Author: WangXiao
...
int main(int argc,char *argv[])
{
  ...
  if (argc!=5)
  {
    ...
    printf("Example:~/root/project/tools/bin/procctl 120 ~/root/project/tools/bin/execsql ~/root/project/idc/sql/cleardata.sql \"127.0.0.1,root,cis623,mysql,3306\" utf8 ~/root/log/idc/execsql.log\n\n");
    ...
    printf("This is a utility program used to execute an SQL script file.\n");
    printf("sqlfile is the SQL script file name. Each SQL statement can be written in multiple lines. A semicolon indicates the end of an SQL statement. Comments are not supported.\n");
