...
~/root/project/tools/bin/procctl 300 ~/root/project/tools/bin/checkproc

# 压缩数据中心后台服务程序的备份日志。
~/root/project/tools/bin/procctl 300 ~/root/project/tools/bin/gzipfiles ~/root/log/idc "*.log.20*" 0.02

# 生成用于测试的全国气象站点观测的分钟数据。
~/root/project/tools/bin/procctl  60 ~/root/project/idc/bin/crtsurfdata ~/root/project/idc/ini/stcode.ini ~/root/tmp/idc/surfdata ~/root/log/idc/crtsurfdata.log xml,json,csv

# 清理原始的全国气象站点观测的分钟数据目录/tmp/idc/surfdata中的历史数据文件。
~/root/project/tools/bin/procctl 300 ~/root/project/tools/bin/deletefiles ~/root/tmp/idc/surfdata "*" 0.02

# 下载全国气象站点观测的分钟数据的xml文件。
~/root/project/tools/bin/procctl 30 ~/root/project/tools/bin/ftpgetfiles ~/root/log/idc/ftpgetfiles_surfdata.log "<host>10.0.2.15:21</host><mode>1</mode><username>cis623-vm</username><password>cis623</password><localpath>/home/cis623-vm/root/idcdata/surfdata</localpath><remotepath>/home/cis623-vm/root/tmp/idc/surfdata</remotepath><matchname>SURF_ZH*.XML</matchname><listfilename>/home/cis623-vm/root/idcdata/ftplist/ftpgetfiles_surfdata.list</listfilename><ptype>1</ptype><okfilename>/home/cis623-vm/root/idcdata/ftplist/ftpgetfiles_surfdata.xml</okfilename><checkmtime>true</checkmtime><timeout>80</timeout><pname>ftpgetfiles_surfdata</pname>"

# 上传全国气象站点观测的分钟数据的xml文件。
~/root/project/tools/bin/procctl 30 ~/root/project/tools/bin/ftpputfiles ~/root/log/idc/ftpputfiles_surfdata.log "<host>10.0.2.15:21</host><mode>1</mode><username>cis623-vm</username><password>cis623</password><localpath>/home/cis623-vm/root/idcdata/surfdata</localpath><remotepath>/home/cis623-vm/root/tmp/ftpputest</remotepath><matchname>SURF_ZH*.JSON</matchname><ptype>1</ptype><localpathbak>/home/cis623-vm/root/tmp/idc/surfdatabak</localpathbak><okfilename>/home/cis623-vm/root/idcdata/ftplist/ftpputfiles_surfdata.xml</okfilename><timeout>80</timeout><pname>ftpputfiles_surfdata</pname>"

# 清理采集的全国气象站点观测的分钟数据目录/idcdata/surfdata中的历史数据文件。
~/root/project/tools/bin/procctl 300 ~/root/project/tools/bin/deletefiles ~/root/idcdata/surfdata "*" 0.02

# 清理采集的全国气象站点观测的分钟数据目录/tmp/ftpputest中的历史数据文件。
~/root/project/tools/bin/procctl 300 ~/root/project/tools/bin/deletefiles ~/root/tmp/ftpputest "*" 0.02

# 文件传输的服务端程序。
~/root/project/tools/bin/procctl 10 ~/root/project/tools/bin/fileserver 5005 ~/root/log/idc/fileserver.log

# 把目录/tmp/ftpputest中的文件上传到/tmp/tcpputest目录中。
~/root/project/tools/bin/procctl 20 ~/root/project/tools/bin/tcpputfiles ~/root/log/idc/tcpputfiles_surfdata.log "<ip>10.0.2.15</ip><port>5005</port><ptype>1</ptype><clientpath>/home/cis623-vm/root/tmp/ftpputest</clientpath><andchild>true</andchild><matchname>*.XML,*.CSV,*.JSON</matchname><srvpath>/home/cis623-vm/root/tmp/tcpputest</srvpath><timetvl>10</timetvl><timeout>50</timeout><pname>tcpputfiles_surfdata</pname>"

# 把目录/tmp/tcpputest中的文件下载到/tmp/tcpgetest目录中。
/home/cis623-vm/root/project/tools/bin/procctl 20 /home/cis623-vm/root/project/tools/bin/tcpgetfiles /home/cis623-vm/root/log/idc/tcpgetfiles_surfdata.log "<ip>10.0.2.15</ip><port>5005</port><ptype>1</ptype><srvpath>/home/cis623-vm/root/tmp/tcpputest</srvpath><andchild>true</andchild><matchname>*.XML,*.CSV,*.JSON</matchname><clientpath>/home/cis623-vm/root/tmp/tcpgetest</clientpath><timetvl>10</timetvl><timeout>50</timeout><pname>tcpgetfiles_surfdata</pname>"

# 清理采集的全国气象站点观测的分钟数据目录/tmp/tcpgetest中的历史数据文件。
/home/cis623-vm/root/project/tools/bin/procctl 300 /home/cis623-vm/root/project/tools/bin/deletefiles /home/cis623-vm/root/tmp/tcpgetest ./"*" 0.02

#把全国站点参数数据保存到数据库表中，如果站点不存在则插入，站点已存在则更新。
/home/cis623-vm/root/project/tools/bin/procctl 120 /home/cis623-vm/root/project/idc/bin/obtcodetodb /home/cis623-vm/root/project/idc/ini/stcode.ini "127.0.0.1,root,cis623,mysql,3306" utf8 /home/cis623-vm/root/log/idc/obtcodetodb.log

# 把全国站点分钟观测数据保存到数据库的T_ZHOBTMIND表中，数据只插入，不更新。
/home/cis623-vm/root/project/tools/bin/procctl 10 /home/cis623-vm/root/project/idc/bin/obtmindtodb /home/cis623-vm/root/idcdata/surfdata "127.0.0.1,root,cis623,mysql,3306" utf8 /home/cis623-vm/root/log/idc/obtmindtodb.log

# 清理T_ZHOBTMIND?表中120分之前的数据，防止磁盘空间被撑满。
/home/cis623-vm/root/project/tools/bin/procctl 120 /home/cis623-vm/root/project/tools/bin/execsql /home/cis623-vm/root/project/idc/sql/cleardata.sql "127.0.0.1,root,cis623,mysql,3306" utf8 /home/cis623-vm/root/log/idc/execsql.log
