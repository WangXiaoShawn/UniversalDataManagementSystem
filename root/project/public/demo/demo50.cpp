...
int main(int argc,char *argv[])
{
  ...
  if (ftp.login("10.0.2.15:21","cis623-vm","cis623",FTPLIB_PASSIVE) == false)
  {
    printf("ftp.login(10.0.2.15:21(cis623_vm/vis623)) failed.\n"); return -1;
  }

  printf("ftp.login(10.0.2.15:21(cis623_vm/vis623)) ok.\n");
